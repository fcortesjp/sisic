...
<html>
        ...
        <title>IngreseLeITeacher</title>
	        ...
	        <script type="text/javascript" charset="utf-8">
	        	...
	        	function btnsave_Click()
	        	{
		        	...
		        	var goal = document.getElementById ("tbgoal").value.replace(/(\r\n|\n|\r)/gm," "); // goal text box trimmed
    ...
    <?php
        if(isset($_SESSION['currentUser'])) // if the super global variable session called current user has been initialized then
        {
            ...
            $tbmaxsize = 100; // size of text boxes
            		...
            		//**************************************************************
                        ...
                        echo '<tr>'; // row 2
                            ...
                            echo '<td>'; // cell 2.2
                                ...
                                echo '<input type="radio" name="rdPeriod" id="per1" value="1">I ';
                                echo '<input type="radio" name="rdPeriod" id="per2" value="2">II ';
                                echo '<input type="radio" name="rdPeriod" id="per3" value="3">III ';
                                echo '<input type="radio" name="rdPeriod" id="per4" value="4">IV ';
                            echo '</td>';
                        ...
                        echo '<tr>'; //row 3
                            ...
                            echo '<td>'; //cell 3.2
                                ...
                                echo '<textarea name="tbgoal" id="tbgoal" maxlength ='.$tbmaxsize.'></textarea><br>';
                        ...
                        echo '<tr>'; //row 4
                            ...
                            echo '<td>'; //cell 4.2
                                ...
                                echo '<input name="tbIndicator1" id="tbIndicator1" type="text" size="'.$tbmaxsize.'" maxlength="'.$tbmaxsize.'"></input><br>';
                        ...
                        echo '<tr>'; //row 5
                            ...
                            echo '<td>'; //cell 5.2
                                ...
                                echo '<input name="tbIndicator2" id="tbIndicator2" type="text" size="'.$tbmaxsize.'" maxlength="'.$tbmaxsize.'"></input><br>';
                        ...
                        echo '<tr>'; //row 6
                            ...
                            echo '<td>'; //cell 6.2
                                ...
                                echo '<input name="tbIndicator3" id="tbIndicator3" type="text" size="'.$tbmaxsize.'" maxlength="'.$tbmaxsize.'"></input><br>';
                        ...
                        echo '<tr>'; //row 7
                            ...
                            echo '<td>'; //cell 7.2
                                ...
                                echo '<input name="tbIndicator4" id="tbIndicator4" type="text" size="'.$tbmaxsize.'" maxlength="'.$tbmaxsize.'"></input><br>';
                        ...
                        echo '<tr>'; //row 8
                            ...
                            echo '<td>'; //cell 8.2
                                ...
                                echo '<input name="tbIndicator5" id="tbIndicator5" type="text" size="'.$tbmaxsize.'" maxlength="'.$tbmaxsize.'"></input><br>';
                        ...
                        echo '<tr>'; //row 9
                            ...
                            echo '<td>'; //cell 9.2
                                ...
                                echo '<input name="tbIndicator6" id="tbIndicator6" type="text" size="'.$tbmaxsize.'" maxlength="'.$tbmaxsize.'"></input><br>';
                        ...
                        echo '<tr>'; //row 10
                            ...
                            echo '<td>'; //cell 10.2
                                ...
                                echo '<input name="tbIndicator7" id="tbIndicator7" type="text" size="'.$tbmaxsize.'" maxlength="'.$tbmaxsize.'"></input><br>';
